 ...
 */
class WeakHandler {
    private val mCallback // hard reference to Callback. We need to keep callback in memory
            : Handler.Callback?
     ...
     */
    constructor(@Nullable callback: Handler.Callback?) {
        mCallback = callback // Hard referencing body
        mExec =
            ExecHandler(WeakReference(callback)) // Weak referencing inside ExecHandler
    }
